...
CORS(                                                                       # Enable CORS for the Flask app to allow cross-origin requests
    app,
...
def token_required(f):
    ...
    def decorated():
        ...
        except jwt.ExpiredSignatureError:                                             # default exception for expired token
            return jsonify({"error": "Token expired"}), 401

        except jwt.InvalidTokenError:                                                 # default exception for invalid token
